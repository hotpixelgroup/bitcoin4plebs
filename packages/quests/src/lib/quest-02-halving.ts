  ...
  stops: [
    ...
    },
    {
      ...
      annotations: [
        ...
        { lines: 'L129, 131', text: 'No shortcuts on mainnet: easy-difficulty blocks are banned and retargeting can never be switched off.' },
        { lines: 'L130', text: 'An unrelated flag (a testnet-only timestamp rule, BIP94), switched off on mainnet.' },
      ],
      excerpt: {
