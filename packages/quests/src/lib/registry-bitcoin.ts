...
/**
 * The bitcoin4plebs curriculum, in order.
 *
 * Split from the Lightning list so a build of one site does not carry the
 * other's prose: the app imports whichever of these two files matches its
 * VITE_SITE, and the bundler drops the rest.
 */
