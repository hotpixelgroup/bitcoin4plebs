...
export const quest04: Quest = {
  ...
  summary:
    'There is no admin key, no board, no upgrade server. See why even 51% of miners can\'t print a coin — and fork the rules yourself to feel where the power actually lives.',
  duration: '9 min',
  pin: BITCOIN_PIN,
  intro: [
    'Every system you\'ve ever used has an owner who can change the rules on you — a bank, a platform, a government. Bitcoin\'s strangest property is that it doesn\'t. This quest looks for the admin switch, finds out what happens to rule-breakers with majority power, reads the scars of the times the rules *did* change — and ends with you changing them yourself, to see exactly what that gets you.',
  ],
  promise:
  ...
  stops: [
    {
      id: 'no-admin-key',
      title: 'There is no admin switch — the developers say so in a comment',
      takeaway:
        'You met MAX_MONEY in Quest #1. Read its comment again with new eyes: even *this* constant\'s exact value is **"consensus critical"** — the developers writing that **they too cannot touch it** without splitting the network.',
      prose: [
    ...
    },
    {
      ...
      prose: [
        ...
        'How did each activate? Not by decree. Developers proposed; node operators chose to run the new code; miners signaled readiness in their blocks; and only past overwhelming thresholds did the new rule take effect. The process takes **years per change** — SegWit\'s activation was fought over for two of them. That slowness isn\'t bureaucracy. It\'s what "nobody can change the rules on you" costs, and what it\'s worth.',
      ],
      annotations: [
        ...
        { lines: 'L125', text: 'Taproot\'s marker (2021) — the most recent change. Note the pace: four rule changes in the last decade.' },
      ],
      excerpt: {
