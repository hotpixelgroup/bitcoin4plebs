...
export const glossary: GlossaryEntry[] = [
  ...
  },
  {
    ...
    category: 'Money & supply',
    definition:
      'The constant 100,000,000 — how many satoshis make one displayed bitcoin. Purely a bookkeeping convention: nothing in the consensus rules ever needs "one BTC."',
    cite: 'amount.h:15',
    quest: 1,
  },
  {
  ...
  },
  {
    ...
    category: 'Keys & ownership',
    definition:
      "The specific elliptic curve Bitcoin's signatures use. Its key space is a number with 78 digits — guessing a key is not \"hard\" in the everyday sense; it is out of reach of every computer humanity will ever build.",
    quest: 3,
  },
  {
    term: 'Key space',
  ...
  },
  {
    ...
    category: 'Keys & ownership',
    definition:
      'The opcode at the bottom of the rabbit hole: a signature and a public key go in, the curve math runs, and a single true/false comes out. Every spend of every coin ultimately funnels through this verdict.',
  ...
  },
  {
    ...
    category: 'Transactions & the mempool',
    definition:
      'A reference to an existing output plus the proof (signature) that opens its lock. Every input of every transaction is signature-checked by every node — no exceptions, no VIP path.',
  ...
  },
  {
    ...
    category: 'Transactions & the mempool',
    definition:
      'Your transaction is "confirmed" when a mined block includes it — that\'s 1 confirmation — and every block stacked on top adds another. Each one multiplies the proof-of-work an attacker would need to redo to undo you.',
    quest: 7,
  },
  ...
  },
  {
    ...
    category: 'Blocks & mining',
    definition:
      "Bitcoin's convention for block and transaction IDs: run SHA-256, then run it again on the result. Your browser does exactly this in Quests #6 and #8 — same function as every mining rig.",
    quest: 8,
  },
  {
    term: 'Merkle root',
  ...
  },
  {
    ...
    category: 'Blocks & mining',
    definition:
      'Every 2,016 blocks, each node measures how long they actually took versus the intended two weeks and retunes the target — correction clamped to 4× either way. A thermostat with no thermostat-keeper.',
    quest: 6,
  },
  {
    term: 'Proof-of-work',
  ...
  },
  {
    ...
    category: 'Blocks & mining',
    definition:
      'Anyone burning electricity on the hash lottery for the right to append the next block and collect subsidy + fees. Miners order transactions; they do **not** make the rules — every block they find is audited by every node.',
    quest: 4,
  },
  {
    term: 'Genesis block',
  ...
  },
  {
    ...
    category: 'Blocks & mining',
    definition:
      'What a hashpower majority can actually do: reorder *recent* blocks (enabling double-spends of fresh payments). What it cannot do: print coins, steal keys, or change rules — rule-breaking blocks are discarded by every node no matter how much work they carry.',
    cite: 'validation.cpp:2621',
    quest: 4,
  },
  ...
  },
  {
    ...
    category: 'Addresses & encoding',
    definition:
      'The checksum polynomial every wallet runs over an address before sending. Its BCH-code construction *guarantees* catching up to 4 mistyped characters in strings up to 89 long — an address is 42.',
    cite: 'bech32.cpp:130',
    quest: 10,
  },
  {
  ...
  },
  {
    ...
    category: 'Addresses & encoding',
    definition:
      'The 2021 soft fork adding witness version 1 (bc1p addresses) and Schnorr signatures — making complex locks look identical to simple ones on-chain. The most recent consensus change as of the pinned commit.',
  ...
  // ——— The network & your node ———
  {
    ...
    definition:
      'A computer running Bitcoin software that independently verifies every block and transaction against the consensus rules, keeping its own copy of the chain. Running one means taking nobody\'s word for anything — the point of this entire site.',
    quest: 9,
  },
  {
    term: 'Bitcoin Core',
  ...
  },
  {
    ...
    category: 'The network & your node',
    definition:
      'A new node\'s first days: fetch every block since 2009 from peers and re-run the full audit on each, rebuilding the entire state of Bitcoin from block zero. Nobody hands your node a balance sheet — it derives one.',
    quest: 9,
  },
  {
    term: 'assumevalid',
    ...
    category: 'The network & your node',
    definition:
      'The disclosed shortcut: by default, signature checks are skipped for blocks buried beneath a reviewed checkpoint baked into each release. Amounts, subsidies, and double-spends are still fully verified — and `-assumevalid=0` refuses even this.',
  ...
  },
  {
    ...
    category: 'The network & your node',
    definition:
      "How a brand-new node finds the network with no signup: a short list of introduction services run by named developers, hard-coded and used once. Seeds can only say hello — every block they lead you to still gets fully verified.",
  ...
  },
  {
    ...
    category: 'Rules, forks & history',
    definition:
      'A *tightening* of the rules that old software still tolerates — the only way Bitcoin\'s rules have changed in over a decade. Each one activated only after near-unanimous adoption, and its block height is carved into the code like a tree ring.',
