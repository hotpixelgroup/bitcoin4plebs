    ...
    <div className="cols">
      <div className="prose">
        <p>
          ...
          serialized to <strong>little-endian</strong> bytes, because Bitcoin writes its
          numbers "backwards," least significant byte first. Concatenate them and exactly
          80 bytes fall out.
        </p>
        ...
        {decoded && (
          <Callout>
            <strong>“{headline}”</strong> That's The Times, 3 January 2009. Straight out of the
